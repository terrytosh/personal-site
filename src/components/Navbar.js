            ...
            <ul className='navbar-nav'>
              ...
              <li className='logo'>
                <a href='#' className='nav-link'>
                  <span className="link-text logo-text">Terry &lt;3</span>
                  <svg
                    aria-hidden="true"
                    focusable="false"
                    data-prefix="fad"
              ...
              <li className='nav-item'>
                <Link to="/personal-site/home" className="nav-link">
                  <svg
                    aria-hidden="true"
                    focusable="false"
                    data-prefix="fad"
              ...
              <li className='nav-item'>
                <Link to="/personal-site/journals" className="nav-link">
                  <svg
                    aria-hidden="true"
                    focusable="false"
                    data-prefix="fad"
              ...
              <li className='nav-item'>
                <Link to="/personal-site/contact" className="nav-link">
                  <svg
                    aria-hidden="true"
                    focusable="false"
                    data-prefix="fad"
